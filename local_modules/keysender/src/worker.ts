...
const handleWorker = (WorkerClass: typeof _Worker): typeof Worker =>
  class {
    ...
    constructor(...args: any[]) {
      ...
      handleSetWorkwindow(worker).apply(null, args as any)
      ...
      lazyGetters(this, {
            ...
            printText: makeCancelable<Keyboard['printText']>(async function (
              ...
              if (text) {
                if (delayAfterCharTyping) {
                  ...
                  const it = new Intl.Segmenter().segment(text)[Symbol.iterator]()

                  let curr = it.next() as any
        ...
        mouse() {
          ...
          const _tremor = (probability: number) => (Math.random() <= probability ? _getSign() : 0)
          ...
          const _curveDotMaker = (start: number, end: number, deviation: number) =>
          ...
          return {
            ...
            async click(button = 'left', delayAfterPress = DEFAULT_DELAY, delayAfterRelease = 0) {
            ...
            humanMoveTo: makeCancelable<Mouse['humanMoveTo']>(async function (
              ...
              let getCurveDots = () => {
                getCurveDots = () => ({
                  ...
                  curveDotX2: _curveDotMaker(xPartStart, xPartEnd, random(0, deviation)),
                  curveDotY2: _curveDotMaker(yPartStart, yPartEnd, random(0, deviation / 2))
                })

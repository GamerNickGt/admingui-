...
const RateLimitBadge = ({ className }) => {
  ...
  return (
    <div
      className={cn(
        'p-2 mt-2 bg-chart-1/10 border-2 border-dashed rounded-sm rounded-r-none border-chart-1/50',
        className
      )}
    >
...
const RefreshBadge = ({ className }) => {
  return (
    <div
      className={cn(
        'p-2 mt-2 bg-chart-1/10 border-2 border-dashed rounded-sm rounded-l-none border-chart-1/50',
        className
      )}
    >
      <div className="flex flex-row gap-2 items-center">

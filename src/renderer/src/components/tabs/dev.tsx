...
function ColorPickerDemoChild({ onThemeChange }: ColorPickerDemoProps) {
...
export function ColorPickerDemo({ onThemeChange }: ColorPickerDemoProps) {
    return (
        <Container>
            <ColorPickerDemoChild onThemeChange={onThemeChange} />
        </Container>
    )
}